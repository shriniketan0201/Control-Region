...
// Wed Jan 26 23:23:51 2022 by ROOT version 6.24/06
// from TTree eventTree/event tree for analysis
// found on file: MC_TTGJets_19.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TH1F *h_photon_Et_range[30];
   TH1F *h_photon_SCEta[30], *h_photon_SCPhi[30], *h_pfMET[30], *h_dPhi_phoMET[30], *h_nJet[30], *h_leadingJetPt[30], *h_leadingJetEta[30], *h_PTMET[30];
   TH1F *h_leptonPt[30], *h_leptonEta[30], *h_leptonPhi[30], *h_photonic_recoil[30], *h_dPhi_phoRecoil[30];
   TH1F *h_JetPt[30], *h_JetEta[30], *h_JetPhi[30];
   TH1F *h_phoPT_over_photonicRecoil[30], *h_leptonPt_over_pfMET[30], *h_lepMET_MT[30];
   TH1F *h_min_dphijetmet[30], *h_min_dphijetrecoil[30], *h_dPhi_lepMET[30], *h_dPhi_phoRecoil_fullrange[30];
   TH1F *h_pfMETPhi[30], *h_pfMETsumEt[30], *h_METoverSqrtSumEt_extended[30], *h_METoverSqrtSumEt[30];
   ...
   virtual void fillHistos(int histoNumber, double event_weight,int index,std::vector<int> jets,std::vector<int> leplist,Float_t leptoMET_to_use,Float_t leptoMET_phi_to_use,Float_t MET_to_use,Float_t uncorrectedPhoEt);
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("MC_TTGJets_19.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("MC_TTGJets_19.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("MC_TTGJets_19.root:/phoJetNtuplizer");
