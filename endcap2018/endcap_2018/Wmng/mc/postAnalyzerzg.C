...
void postAnalyzer::Loop(Long64_t maxEvents, int reportEvery)
{
  ...
  */
  ...
  TH1D *ewkCorrection = (TH1D*)file->Get("zg");
  cout<<"ewkCorrection histo made"<<endl;
  TFile *myroot = new TFile("Efficiencies_muon_generalTracks_Z_Run2018_UL_ID.root");
  TFile *sfroot = new TFile("Efficiencies_muon_generalTracks_Z_Run2018_UL_ISO.root");
	...
	if(HLTPho>>11&1 == 1)
	  {
		...
		// if( TMath::Max( ( (*phoYuPFChWorstIso)[phoCand[0]]  - rho*EAchargedworst((*phoSCEta)[phoCand[0]]) ), 0.0) < 1.37 )
		{
		  ...
		  //		  event_weight = EWK_corrected_weight*NNLOCorrection(phoEt->at(phoCand[0]));  //for the use of LO we have comment this out 
		  event_weight = event_weight*EWK_corrected_weight;   //for the use of LO we have use dthis 
		  ...
		  if(mulist.size() == 1 && looseMus.size() == 1)
		      ...
		      if(leptoMET > 200)
			{
			  ...
			  Float_t MET_to_use = pfMET;
			     ...
			     fillHistos(0,event_weight,phoCand[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,(phoEt->at(phoCand[0])));
			     //fillHistos(0,event_weight,phoCand[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,phoEt->at(phoCand[0]));
			     if(DeltaPhi(phoPhi->at(phoCand[0]),leptoMET_phi_to_use) > 0.5)
			       {
				 fillHistos(1,event_weight,phoCand[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,(phoEt->at(phoCand[0])));
				 if(dPhiJetMET_veto(jetveto))
				   {
				     fillHistos(2,event_weight,phoCand[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,(phoEt->at(phoCand[0])));
				     if(looseEles.size() == 0)
				       {
					 fillHistos(3,event_weight,phoCand[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,(phoEt->at(phoCand[0])));
					 ...
					 if(lepMET_MT < 160 && (phoEt->at(phoCand[0]))/leptoMET_to_use < 1.4 && hem_veto()==false)
					   {
					     fillHistos(4,event_weight,phoCand[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,(phoEt->at(phoCand[0])));
					   }
				       }
				   }
			       }
		      ...
		      if(leptoMET_T1JESUp > 200)
			{
			  ...
			  fillHistos(5,event_weight,phoCand[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,(phoEt->at(phoCand[0])));
			  if(DeltaPhi(phoPhi->at(phoCand[0]),leptoMET_phi_to_use) > 0.5)
			    {
			      fillHistos(6,event_weight,phoCand[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,(phoEt->at(phoCand[0])));
			      if(dPhiJetMET_veto(jetveto))
				{
				  fillHistos(7,event_weight,phoCand[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,(phoEt->at(phoCand[0])));
				  if(looseEles.size() == 0)
				    {
				      fillHistos(8,event_weight,phoCand[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,(phoEt->at(phoCand[0])));
				      Float_t dPhi_lepMET = DeltaPhi(muPhi->at(mulist[0]),pfMETPhi);
				      Float_t lepMET_MT = sqrt(2*muPt->at(mulist[0])*MET_to_use*(1-TMath::Cos(dPhi_lepMET)));
				      if(lepMET_MT < 160 && (phoEt->at(phoCand[0]))/leptoMET_to_use < 1.4  && hem_veto()==false)
					{
					  fillHistos(9,event_weight,phoCand[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,(phoEt->at(phoCand[0])));
					}
				    }
				}
			    }
		      ...
		      if(leptoMET_T1JESDo > 200)
			{
			  ...
			  fillHistos(10,event_weight,phoCand[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,(phoEt->at(phoCand[0])));
			  if(DeltaPhi(phoPhi->at(phoCand[0]),leptoMET_phi_to_use) > 0.5)
			    {
			      fillHistos(11,event_weight,phoCand[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,(phoEt->at(phoCand[0])));
			      if(dPhiJetMET_veto(jetveto))
				{
				  fillHistos(12,event_weight,phoCand[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,(phoEt->at(phoCand[0])));
				  if(looseEles.size() == 0)
				    {
				      fillHistos(13,event_weight,phoCand[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,(phoEt->at(phoCand[0])));
				      Float_t dPhi_lepMET = DeltaPhi(muPhi->at(mulist[0]),pfMETPhi);
				      Float_t lepMET_MT = sqrt(2*muPt->at(mulist[0])*MET_to_use*(1-TMath::Cos(dPhi_lepMET)));
				      if(lepMET_MT < 160 && (phoEt->at(phoCand[0]))/leptoMET_to_use < 1.4  && hem_veto()==false)
					{
					  fillHistos(14,event_weight,phoCand[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,(phoEt->at(phoCand[0])));
					}
				    }
				}
			    }
		...
		{
		  event_weight=1.0;
		  //		  Float_t uncorrectedPhoEta = ((*phoEt)[phoCandUp[0]]);
		  //uncorrectedPhoEt += 0.015*uncorrectedPhoEt;
		  
		  (phoEt->at(phoCandUp[0])) += 0.015*(phoEt->at(phoCandUp[0]));
		  
		  Double_t EWK_percent_adjustment = ewkCorrection->GetBinContent(ewkCorrection->GetXaxis()->FindBin(phoEt->at(phoCandUp[0])));
		  //		  Double_t EWK_percent_adjustment = ewkCorrection->GetBinContent(ewkCorrection->GetXaxis()->FindBin(uncorrectedPhoEt));
		  EWK_corrected_weight = event_weight*(1.0+.01*EWK_percent_adjustment);
		  ...
		  //EWK_corrected_weight = event_weight*(1.0+.01*EWK_percent_adjustment);
                  event_weight = event_weight*EWK_corrected_weight;
		  event_weight*=(1.002 - 0.00004395*phoEt->at(phoCandUp[0]));  
		  ...
		  if(mulist.size() == 1 && looseMus.size() == 1)
		      ...
		      if(leptoMET_T1PESUp > 200)
			{
			  ...
			  fillHistos(15,event_weight,phoCandUp[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,phoEt->at(phoCandUp[0]));
			  if(DeltaPhi(phoPhi->at(phoCandUp[0]),leptoMET_phi_to_use) > 0.5)
			    {
			      fillHistos(16,event_weight,phoCandUp[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,phoEt->at(phoCandUp[0]));
			      if(dPhiJetMET_veto(jetveto))
				{
				  fillHistos(17,event_weight,phoCandUp[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,phoEt->at(phoCandUp[0]));
				  if(looseEles.size() == 0)
				    {
				      fillHistos(18,event_weight,phoCandUp[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,phoEt->at(phoCandUp[0]));
				      Float_t dPhi_lepMET = DeltaPhi(muPhi->at(mulist[0]),pfMETPhi);
				      Float_t lepMET_MT = sqrt(2*muPt->at(mulist[0])*MET_to_use*(1-TMath::Cos(dPhi_lepMET)));
				      if(lepMET_MT < 160 && phoEt->at(phoCandUp[0])/leptoMET_to_use < 1.4  && hem_veto()==false)
					{
					  fillHistos(19,event_weight,phoCandUp[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,phoEt->at(phoCandUp[0]));
					}
				    }
				}
			    }
		...
		{
		  event_weight=1.0;
		  //Float_t phoEt->at(phoCandUp[0]) = ((*phoEt)[phoCandDown[0]]);
		  //uncorrectedPhoEt -= 0.015*uncorrectedPhoEt;
		  (phoEt->at(phoCandDown[0])) += 0.015*(phoEt->at(phoCandDown[0]));		  
		  //		  Double_t EWK_percent_adjustment = ewkCorrection->GetBinContent(ewkCorrection->GetXaxis()->FindBin(uncorrectedPhoEt));
		  Double_t EWK_percent_adjustment = ewkCorrection->GetBinContent(ewkCorrection->GetXaxis()->FindBin(phoEt->at(phoCandDown[0])));
		  EWK_corrected_weight = event_weight*(1.0+.01*EWK_percent_adjustment);
                  //event_weight = EWK_corrected_weight*NNLOCorrection(phoEt->at(phoCandDown[0]));
		  event_weight = event_weight*EWK_corrected_weight;
		  event_weight*=(1.002 - 0.00004395*phoEt->at(phoCandDown[0]));
		  // EWK_corrected_weight = event_weight*(1.0+.01*EWK_percent_adjustment);
		  // event_weight = EWK_corrected_weight*NNLOCorrection(phoEt->at(phoCandDown[0]));
		  ...
		  if(mulist.size() == 1 && looseMus.size() == 1)
		      ...
		      if(leptoMET_T1PESDo > 200)
			{
			  ...
			  fillHistos(20,event_weight,phoCandDown[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,phoEt->at(phoCandDown[0]));
			  if(DeltaPhi(phoPhi->at(phoCandDown[0]),leptoMET_phi_to_use) > 0.5)
			    {
			      fillHistos(21,event_weight,phoCandDown[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,phoEt->at(phoCandDown[0]));
			      if(dPhiJetMET_veto(jetveto))
				{
				  fillHistos(22,event_weight,phoCandDown[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,phoEt->at(phoCandDown[0]));
				  if(looseEles.size() == 0)
				    {
				      fillHistos(23,event_weight,phoCandDown[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,phoEt->at(phoCandDown[0]));
				      Float_t dPhi_lepMET = DeltaPhi(muPhi->at(mulist[0]),pfMETPhi);
				      Float_t lepMET_MT = sqrt(2*muPt->at(mulist[0])*MET_to_use*(1-TMath::Cos(dPhi_lepMET)));
				      if(lepMET_MT < 160 && phoEt->at(phoCandDown[0])/leptoMET_to_use < 1.4  && hem_veto()==false)
					{
					  fillHistos(24,event_weight,phoCandDown[0],jetveto,mulist,leptoMET_to_use,leptoMET_phi_to_use,MET_to_use,phoEt->at(phoCandDown[0]));
					}
				    }
				}
			    }
